...
InMemoryTransactionRepository = __decorate([
    ...
    __param(0, inversify_1.inject("infrastructure.transaction.eventStore")),
    __metadata("design:paramtypes", [hollywood_js_1.EventStore.EventStore])
], InMemoryTransactionRepository);
exports.default = InMemoryTransactionRepository;
